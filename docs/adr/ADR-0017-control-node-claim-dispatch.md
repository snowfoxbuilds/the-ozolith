Status: ACCEPTED — amended 2026-08-17 (#52): the dispatch grant carries claim authority only, never context — the grant-is-the-issue reading is retired; every Run, including local retries, re-reads the issue and PR context from GitHub at checkout, complete within the OWNER/MEMBER comment-authority boundary (see Amendments)
