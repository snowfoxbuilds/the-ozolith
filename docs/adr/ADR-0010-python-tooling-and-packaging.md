...
- **A new top-level ****`pipeline/`**** component for the bootstrap tool**: rejected — [ARCHITECTURE.md](http://architecture.md/) fixes the component list; the pipeline component is `worker/`.
