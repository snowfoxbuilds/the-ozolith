...
- Terminology in ADR-0013 and ADR-0017 ("Worker" there = today's Implementer). ADR-0019 is renamed in place (Pilot → Flight Deck) as a same-day decision. No behavioral contracts change.
