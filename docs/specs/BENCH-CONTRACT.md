...
- The GitHub Relay: socket lifecycle, policy, budgets, redirect rule, trusted audit sink and publication, with an injectable upstream (live host + credential source, or none) (grilling 2026-09-03).
