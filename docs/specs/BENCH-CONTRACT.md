...
- The GitHub Relay: socket lifecycle, policy, budgets and the pre-delivery response gate, per-class redirect rules, write-ahead trusted audit sink and publication, with an injectable upstream (live GitHub.com credential source, or none) (grilling 2026-09-03).
