...
def _prepare_checkout(clone_url: str, workdir: Path) -> None:
    try:
        gitops.clone(clone_url, workdir, branch=EVIDENCE_BRANCH)
    except GitError:
