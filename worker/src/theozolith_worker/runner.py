...
def _run_to_pr(
    ...
    # advertisement instead of the whole history. Mirror failures raise
    # GitError and land in the pre-session infra lane (ADR-0016).
    gitops.clone_with_mirror(config.clone_url, config.mirrors_dir, workdir, env=auth)
