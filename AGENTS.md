...
- Monorepo with separable, independently installable components: `knowledge/`, `worker/`, `control/`, `nodeagent/`, `deploy/`. A laptop-only knowledge user never installs the cluster manager.
## Domain Language
...
| docs/specs/[NODE-SUBSTRATE.md](http://node-substrate.md/) | Cluster substrate: Control Node, Node Agent, Config Repo, secrets, extension points |
